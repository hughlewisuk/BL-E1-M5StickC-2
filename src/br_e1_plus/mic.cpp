...
namespace BR_E1_PLUS
{
    ...
    void BR_E1_PLUS::mic_test_one_task()
    {
...
#define PIN_DATA 34
    ...
    void BR_E1_PLUS::new_mic_test_fft()
    {
        printf("mic test\n");
