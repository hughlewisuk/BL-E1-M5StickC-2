...
namespace BR_E1_PLUS
{
    ...
    private:
        ...
        void set_address(String address_str);
        void set_main_menu_screen(void);
        ...
        Button btnALong = Button(37, 2000);
        Button btnBLong = Button(39, 2000);
